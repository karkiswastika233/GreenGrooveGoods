...
$address = mysqli_real_escape_string(
    $conn, 
    'Tole ' . $tole . ', ' . $street . ', ' . $city . ', ' . $country . ' - ' . $pin_code
);
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="Tole" placeholder="e.g. Opposite to NCC medical">
            </div>
            ...
            <div class="inputBox">
                <span>pin code :</span>
                <input type="number" min="0" name="pin_code" placeholder="e.g. 446600">
            </div>
        </div>
